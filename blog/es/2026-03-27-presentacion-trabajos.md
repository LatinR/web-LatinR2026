...
<h3><center>LLAMADO A PRESENTACIÓN DE TRABAJOS</center></h3>

<br> <br> La novena versión de LatinR se llevará a cabo de forma presencial en Medellín, Colombia, entre los días 11 y 13 de noviembre de 2026. En esta edición
se podrá participar con presentaciones orales, charlas relámpago y pósters.
...
<div class="boxBorder">
El envío de trabajos se podrá realizar a partir del mes de abril a través de la plataforma [OpenReview](https://openreview.net/group?id=LATIN-R.com/2026/Conference). Ten en cuenta que es necesario haberse registrado en la plataforma para poder enviar tu trabajo. **El proceso de crear una cuenta puede tomar hasta dos semanas**. **Te sugerimos no dejar la creación de la cuenta para el último minuto**.
</div>
...
participen en esta modalidad dispondrán de 15 minutos para la presentación, seguidos de 5 minutos para preguntas.  <br>
...
-   Existe un paquete desarrollado por Elio Campitelli que permite
    ...
    detalles en [en este post](https://2023.latinr.org/blog/es/2020-03-03-paquete-latinr.html).
    En ediciones anteriores de la conferencia (2018-2022) era posible hacer el envío
    directamente desde R. Actualmente no es posible, ya que la
    ...
    para el envío.
-   Los trabajos deben enviarse a través de la plataforma Open Review a partir de mediados del mes de abril.
    ...
    puede tomar un par de días en quedar habilitada la cuenta si se usa una cuenta institucional y dos semanas si es una cuenta personal. **Se sugiere no dejar la creación de la cuenta para el último minuto**.
...
revisar los videos de las ediciones online de LatinR. En nuestra
cuenta en [GitHub](https://github.com/LatinR) es posible encontrar a los resúmenes y materiales de
presentaciones y pósters de años anteriores.
