---
title: "Tutoriais do LatinR 2026"
categories: "2026"
date: 2026-09-11
ref: tutoriales
---
...
![Colagem de fotos de tutoriais de edições anteriores do LatinR](/img/posts/tutoriales.jpg){fig-alt="Pessoa participando de um tutorial no LatinR" width="100%"}

<br> Já vem chegando a nona edição do LatinR! Este ano, além das palestras e sessões de diálogo, teremos uma grande variedade de tutoriais práticos ministrados por especialistas da comunidade R. A seguir, contamos do que vai se tratar cada um deles.

<br>

#### Automatiza a publicação dos seus relatórios com Quarto e GitHub Actions

![Flyer do tutorial "Automatiza a publicação dos seus relatórios com Quarto e GitHub Actions"](/img/posts/tutorial_quarto-github-actions.png){fig-alt="Flyer do tutorial Automatiza a publicação dos seus relatórios com Quarto e GitHub Actions" width="100%"}
...
![Flyer do tutorial "Making great slides with Quarto and revealjs"](/img/posts/tutorial-slides-quarto.png){fig-alt="Flyer do tutorial Making great slides with Quarto and revealjs" width="100%"}
...
![Flyer do tutorial "LLMs in R using {ellmer}"](/img/posts/tutorial-llms-en-r-con-ellmer.png){fig-alt="Flyer do tutorial LLMs in R using ellmer" width="100%"}
...
![Flyer do tutorial "Construindo modelos de Machine Learning com tidymodels: um tutorial prático"](/img/posts/tutorial-tidymodels.png){fig-alt="Flyer do tutorial Construindo modelos de Machine Learning com tidymodels" width="100%"}
...
![Flyer do tutorial "De idea a paquete: programá tu primer paquete de R"](/img/posts/tutorial-de-idea-a-paquete.png){fig-alt="Flyer do tutorial De idea a paquete" width="100%"}
...
![Flyer do tutorial "Shiny + ellmer: padrões para conectar conversa, dados e interface"](/img/posts/tutorial-shiny-ellmer.png){fig-alt="Flyer do tutorial Shiny + ellmer" width="100%"}
...
Você pode encontrar todas as informações sobre os tutoriais na [página de tutoriais](../../cronograma/tutoriales/index.qmd) do site da conferência.

<br>

### Inscrição

Para se inscrever nos tutoriais, você pode se registrar através do [Eventbrite](https://www.eventbrite.com.ar/e/1998690018649).
