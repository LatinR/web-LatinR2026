...
**El miércoles 11**, LatinR 2026 ofrece un espacio  de tutoriales prácticos, diseñados para fortalecer habilidades específicas en el uso de R. 

Al completar el [registro para la conferencia](https://www.eventbrite.com.ar/e/1998690018649), podrás seleccionar los tutoriales en los que desees participar. La inscripción es flexible: puedes elegir un único tutorial o tantos como sean de tu interés.

Los tutoriales tienen un [costo de inscripción](https://latinr.org/blog/es/2026-08-25-inscripcion.html), que varía según la categoría del participante.
...
Se realizarán tres tutoriales en paralelo por la mañana y tres por la tarde. Por favor, revisa bien los horarios antes de registrarte para confirmar que no estás seleccionando actividades que ocurren en paralelo. 

```{=html}
<table>
<thead>
<tr><th>Horario</th><th colspan="3">Tutoriales</th></tr>
</thead>
<tbody>
<tr>
<td>8:30 - 12:00</td>
...
<tr>
<td>14:00 - 17:30</td>
<td><a href="#taller-tidymodels">Construyendo modelos de Machine Learning con tidymodels: un tutorial práctico</a></td>
...
::: {.tutorial-subtitle}
Aprende a crear grandes diapositivas en Quarto usando revealjs.
:::
